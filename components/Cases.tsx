                            ...
                            <div>
                                ...
                                <div className="bg-white border border-slate-200 rounded-lg p-4 shadow-sm">
                                    <div className="flex items-center justify-between mb-2">
                                        ...
                                        <span className={`px-2 py-0.5 rounded text-xs font-medium ${selectedCase.status === CaseStatus.OPEN ? 'bg-green-100 text-green-800' : 'bg-slate-100 text-slate-800'
                                            ...
                                            {selectedCase.nextHearing && (
                                                <button
                                                    onClick={() => openGoogleCalendarEvent({
                                                        title: `Hearing: ${selectedCase.title}`,
                                                        date: selectedCase.nextHearing,
                                                        description: `Case: ${selectedCase.title}\nCase No: ${selectedCase.caseNumber}\nClient: ${selectedCase.clientName}`,
                                                        location: selectedCase.court || selectedCase.workplace || undefined
                                                    })}
                                                    className="p-1 text-blue-500 hover:bg-blue-50 rounded" title="Add to Google Calendar"
                                                >
                                                ...
                                                <div className="bg-white p-3 rounded-lg border border-slate-200 shadow-sm hover:border-indigo-200 transition-colors">
                                                    ...
                                                    {hearing.nextHearingDate && (
                                                        <div className="mt-2 text-xs flex items-center justify-between">
                                                            ...
                                                            <button
                                                                onClick={() => openGoogleCalendarEvent({
                                                                    title: `Hearing: ${selectedCase.title} — ${hearing.purpose}`,
                                                                    date: hearing.nextHearingDate,
                                                                    description: `Case: ${selectedCase.title}\nCase No: ${selectedCase.caseNumber}\nPurpose: ${hearing.purpose}\nNotes: ${hearing.notes || 'N/A'}`,
                                                                    location: selectedCase.court || selectedCase.workplace || undefined
                                                                })}
                                                                className="flex items-center gap-1 text-[10px] text-blue-600 hover:bg-blue-50 px-2 py-0.5 rounded font-medium"
                                                            >
